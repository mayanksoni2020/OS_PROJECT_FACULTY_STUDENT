...
int main()
{
  printf("\t\tWelcome to Process Management\n");
  int p,facc=0,stuc=0;
...
//tim++;
      printf("\n\nProcess\t|Turnaround Time|Waiting Time\n\n");
      printf("F[%d]\t|\t%d\t|\t%d\n",u+1,tim-wtff[u]+1,tim-rff[u]-wtff[u]+1);
  ...
  for(l=0;op!=0;)
  {
    ...
    if(bff[l]==0 && flag==1)
    {
      op--;
      printf("\n\nProcess\t|Turnaround Time|Waiting Time\n\n");
      printf("F[%d]\t|\t%d\t|\t%d\n",l+1,tim-wtff[l]+1,tim-rff[l]-wtff[l]+1);
